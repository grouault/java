...
public class SloganPersistenceImpl extends BasePersistenceImpl<Slogan>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			SloganModelImpl.UUID_COLUMN_BITMASK |
			SloganModelImpl.SLOGANDATE_COLUMN_BITMASK);
	...
	public List<Slogan> findByUuid(String uuid, int start, int end,
		...
		List<Slogan> list = (List<Slogan>)FinderCacheUtil.getResult(finderPath,
				finderArgs, this);

		if ((list != null) && !list.isEmpty()) {
			for (Slogan slogan : list) {
				if (!Validator.equals(uuid, slogan.getUuid())) {
					list = null;
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					...
					list = new UnmodifiableList<Slogan>(list);
				}
				else {
					list = (List<Slogan>)QueryUtil.list(q, getDialect(), start,
							end);
	...
	public Slogan findByUuid_First(String uuid,
		...
		Slogan slogan = fetchByUuid_First(uuid, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public Slogan findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
	...
	protected Slogan getByUuid_PrevAndNext(Session session, Slogan slogan,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(slogan);
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (Slogan slogan : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			...
			SloganModelImpl.UUID_COLUMN_BITMASK |
			SloganModelImpl.GROUPID_COLUMN_BITMASK);
	...
	public Slogan fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof Slogan) {
			Slogan slogan = (Slogan)result;

			if (!Validator.equals(uuid, slogan.getUuid()) ||
					(groupId != slogan.getGroupId())) {
				result = null;
			}
		}
	 ...
	 */
	@Override
	public Slogan removeByUUID_G(String uuid, long groupId)
		throws NoSuchSloganException, SystemException {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			SloganModelImpl.UUID_COLUMN_BITMASK |
			SloganModelImpl.COMPANYID_COLUMN_BITMASK |
			SloganModelImpl.SLOGANDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Slogan> findByUuid_C(String uuid, long companyId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Slogan> findByUuid_C(String uuid, long companyId, int start,
	 ...
	 */
	@Override
	public Slogan findByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Slogan> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Slogan findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Slogan> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Slogan[] findByUuid_C_PrevAndNext(long sloganId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, slogan, uuid,
					companyId, orderByComparator, true);

			array[1] = slogan;

			array[2] = getByUuid_C_PrevAndNext(session, slogan, uuid,
	...
	protected Slogan getByUuid_C_PrevAndNext(Session session, Slogan slogan,
	...
	public void removeByUuid_C(String uuid, long companyId)
		throws SystemException {
		for (Slogan slogan : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(slogan);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "slogan.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "slogan.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(slogan.uuid IS NULL OR slogan.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "slogan.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
	...
	public Slogan findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByGroupId_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByGroupId_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public Slogan findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByGroupId_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByGroupId_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public List<Slogan> filterFindByGroupId(long groupId, int start, int end,
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				Slogan.class.getName(), _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN,
				groupId);
	 ...
	 */
	@Override
	public Slogan[] filterFindByGroupId_PrevAndNext(long sloganId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(sloganId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, slogan, groupId,
					orderByComparator, true);

			array[1] = slogan;

			array[2] = filterGetByGroupId_PrevAndNext(session, slogan, groupId,
					orderByComparator, false);
	...
	protected Slogan filterGetByGroupId_PrevAndNext(Session session,
		Slogan slogan, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Slogan slogan : findByGroupId(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(slogan);
		}
	}
	...
	public List<Slogan> findByCompanyId(long companyId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Slogan slogan : list) {
				if ((companyId != slogan.getCompanyId())) {
					list = null;
	...
	public Slogan findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByCompanyId_First(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByCompanyId_First(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public Slogan findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByCompanyId_Last(companyId, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public void removeByCompanyId(long companyId) throws SystemException {
		for (Slogan slogan : findByCompanyId(companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(slogan);
		}
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SLOGANTEXT =
		new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBySloganText",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SLOGANTEXT =
		new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBySloganText",
			new String[] { String.class.getName() },
			SloganModelImpl.SLOGANTEXT_COLUMN_BITMASK |
			SloganModelImpl.SLOGANDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_SLOGANTEXT = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBySloganText",
			new String[] { String.class.getName() });
	...
	public List<Slogan> findBySloganText(String sloganText, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SLOGANTEXT;
			finderArgs = new Object[] { sloganText };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_SLOGANTEXT;
			finderArgs = new Object[] { sloganText, start, end, orderByComparator };
		}
		...
		if ((list != null) && !list.isEmpty()) {
			for (Slogan slogan : list) {
				if (!Validator.equals(sloganText, slogan.getSloganText())) {
					list = null;
		...
		if (list == null) {
			...
			boolean bindSloganText = false;

			if (sloganText == null) {
				query.append(_FINDER_COLUMN_SLOGANTEXT_SLOGANTEXT_1);
			}
			else if (sloganText.equals(StringPool.BLANK)) {
	...
	public Slogan findBySloganText_First(String sloganText,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchBySloganText_First(sloganText, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchBySloganText_First(String sloganText,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public Slogan findBySloganText_Last(String sloganText,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchBySloganText_Last(sloganText, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchBySloganText_Last(String sloganText,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public void removeBySloganText(String sloganText) throws SystemException {
		for (Slogan slogan : findBySloganText(sloganText, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(slogan);
		}
	}
	...
	public int countBySloganText(String sloganText) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_SLOGANTEXT;
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_S = new FinderPath(SloganModelImpl.ENTITY_CACHE_ENABLED,
			SloganModelImpl.FINDER_CACHE_ENABLED, SloganImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_S",
			new String[] { Long.class.getName(), Integer.class.getName() },
			SloganModelImpl.GROUPID_COLUMN_BITMASK |
			SloganModelImpl.STATUS_COLUMN_BITMASK |
			SloganModelImpl.SLOGANDATE_COLUMN_BITMASK);
	...
	public Slogan findByG_S_First(long groupId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByG_S_First(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByG_S_First(long groupId, int status,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public Slogan findByG_S_Last(long groupId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByG_S_Last(groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Slogan fetchByG_S_Last(long groupId, int status,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Slogan[] filterFindByG_S_PrevAndNext(long sloganId, long groupId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchSloganException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_S_PrevAndNext(sloganId, groupId, status,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_S_PrevAndNext(session, slogan, groupId,
					status, orderByComparator, true);

			array[1] = slogan;

			array[2] = filterGetByG_S_PrevAndNext(session, slogan, groupId,
	...
	protected Slogan filterGetByG_S_PrevAndNext(Session session, Slogan slogan,
		long groupId, int status, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_S(long groupId, int status) throws SystemException {
		for (Slogan slogan : findByG_S(groupId, status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(slogan);
		}
	}
	...
	public SloganPersistenceImpl() {
		setModelClass(Slogan.class);
	}
	...
	public void cacheResult(Slogan slogan) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { slogan.getUuid(), slogan.getGroupId() }, slogan);

		slogan.resetOriginalValues();
	}
	...
	public void clearCache(Slogan slogan) {
		...
		clearUniqueFindersCache(slogan);
	}

	@Override
	public void clearCache(List<Slogan> slogans) {
		FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITH_PAGINATION);
		FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
	...
	protected void cacheUniqueFindersCache(Slogan slogan) {
		if (slogan.isNew()) {
			Object[] args = new Object[] { slogan.getUuid(), slogan.getGroupId() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_UUID_G, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G, args, slogan);
		}
		else {
			SloganModelImpl sloganModelImpl = (SloganModelImpl)slogan;

			if ((sloganModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_UUID_G.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						slogan.getUuid(), slogan.getGroupId()
					};
	...
	protected void clearUniqueFindersCache(Slogan slogan) {
		SloganModelImpl sloganModelImpl = (SloganModelImpl)slogan;
		...
		if ((sloganModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					sloganModelImpl.getOriginalGroupId()
				};
	...
	public Slogan remove(long sloganId)
		throws NoSuchSloganException, SystemException {
		return remove((Serializable)sloganId);
	}

	/**
	 * Removes the slogan with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the slogan
	 * @return the slogan that was removed
	 * @throws com.inkwell.internet.slogan.NoSuchSloganException if a slogan with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public Slogan remove(Serializable primaryKey)
		...
		try {
			...
			Slogan slogan = (Slogan)session.get(SloganImpl.class, primaryKey);
	...
	protected Slogan removeImpl(Slogan slogan) throws SystemException {
		...
		try {
			...
			if (!session.contains(slogan)) {
				slogan = (Slogan)session.get(SloganImpl.class,
						slogan.getPrimaryKeyObj());
			}
	...
	public Slogan updateImpl(com.inkwell.internet.slogan.model.Slogan slogan)
		...
		if (isNew || !SloganModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((sloganModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { sloganModelImpl.getOriginalUuid() };

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
					args);

				args = new Object[] { sloganModelImpl.getUuid() };
			...
			if ((sloganModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						sloganModelImpl.getOriginalUuid(),
						sloganModelImpl.getOriginalCompanyId()
					};
			...
			if ((sloganModelImpl.getColumnBitmask() &
				...
				args = new Object[] { sloganModelImpl.getGroupId() };
			...
			if ((sloganModelImpl.getColumnBitmask() &
				...
				args = new Object[] { sloganModelImpl.getCompanyId() };
			...
			if ((sloganModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SLOGANTEXT.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						sloganModelImpl.getOriginalSloganText()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_SLOGANTEXT,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SLOGANTEXT,
					args);

				args = new Object[] { sloganModelImpl.getSloganText() };
			...
			if ((sloganModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						sloganModelImpl.getOriginalGroupId(),
						sloganModelImpl.getOriginalStatus()
					};
				...
				args = new Object[] {
						sloganModelImpl.getGroupId(),
						sloganModelImpl.getStatus()
					};
		...
		clearUniqueFindersCache(slogan);
		cacheUniqueFindersCache(slogan);
	...
	/**
	 * Returns the slogan with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the slogan
	 * @return the slogan
	 * @throws com.inkwell.internet.slogan.NoSuchSloganException if a slogan with the primary key could not be found
	...
	public Slogan findByPrimaryKey(Serializable primaryKey)
		throws NoSuchSloganException, SystemException {
		Slogan slogan = fetchByPrimaryKey(primaryKey);
	...
	public Slogan findByPrimaryKey(long sloganId)
		throws NoSuchSloganException, SystemException {
		return findByPrimaryKey((Serializable)sloganId);
	}
	...
	public Slogan fetchByPrimaryKey(Serializable primaryKey)
		...
		Slogan slogan = (Slogan)EntityCacheUtil.getResult(SloganModelImpl.ENTITY_CACHE_ENABLED,
				SloganImpl.class, primaryKey);

		if (slogan == _nullSlogan) {
			return null;
		}
		...
		if (slogan == null) {
			...
			try {
				...
				slogan = (Slogan)session.get(SloganImpl.class, primaryKey);
				...
				if (slogan != null) {
					...
					EntityCacheUtil.putResult(SloganModelImpl.ENTITY_CACHE_ENABLED,
						SloganImpl.class, primaryKey, _nullSlogan);
				}
			}
			catch (Exception e) {
				EntityCacheUtil.removeResult(SloganModelImpl.ENTITY_CACHE_ENABLED,
	...
	public Slogan fetchByPrimaryKey(long sloganId) throws SystemException {
		return fetchByPrimaryKey((Serializable)sloganId);
	}
	...
	public List<Slogan> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_SLOGAN;

				if (pagination) {
					sql = sql.concat(SloganModelImpl.ORDER_BY_JPQL);
				}
			}
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "slogan.sloganId";
	...
	private static Slogan _nullSlogan = new SloganImpl() {
			@Override
			public Object clone() {
				return this;
			}
			...
			public CacheModel<Slogan> toCacheModel() {
				return _nullSloganCacheModel;
			}
		};

	private static CacheModel<Slogan> _nullSloganCacheModel = new CacheModel<Slogan>() {
			@Override
