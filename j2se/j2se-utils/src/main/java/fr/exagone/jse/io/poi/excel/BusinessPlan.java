...
public class BusinessPlan {
	...
	private static DateFormat fmt = new SimpleDateFormat("dd-MMM");
    ...
    public static void main(String[] args) throws Exception {
        ...
        try{
        	String strDate = "09-Jul";
        calendar.setTime(fmt.parse(strDate));
        }
        catch (ParseException e) {
        	System.out.println("Parsing en erreur: " + e.getMessage());
        ...
        String file = FILE_PATH + "businessplan.xls";
